...
The setup takes under five minutes. Install the npm package, run `remoteagent init`, open [remoteagent.chat/connect](https://remoteagent.chat/connect) on your phone, enter the pairing code, and you're done.

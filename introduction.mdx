...
The setup takes under five minutes. Download the binary, run `remoteagent init`, open [remoteagent.chat/connect](https://remoteagent.chat/connect) on your phone, enter the pairing code, and you're done.
...
<Note>
  The RemoteAgent binary is self-contained — no Node.js or runtime required.

---
title: "Pricing"
description: "RemoteAgent plans and pricing. Start free with a 14-day trial — no credit card required."
---
...
<CardGroup cols={4}>
  ...
  <Card title="Solo" icon="user">
    **$5 / month**
    ...
    Up to 3 projects. 1 Telegram user. Voice input up to 30 min/month. Best for individual developers.
  </Card>
  ...
  <Card title="Team" icon="users">
    **$29 / month**
    ...
    Unlimited projects. Up to 5 Telegram users. Each member switches projects independently. Session awareness notifications. Best for small teams.
  </Card>
</CardGroup>

## Feature comparison

| Feature | Trial | Solo | Pro | Team |
|---|---|---|---|---|
| Price | Free | $5/mo | $12/mo | $29/mo |
| Duration | 14 days | Monthly | Monthly | Monthly |
| Credit card required | No | Yes | Yes | Yes |
| Projects | Unlimited | 3 | Unlimited | Unlimited |
| Telegram users | 1 | 1 | 1 | 5 |
| Voice input | 30 min/mo | 30 min/mo | Unlimited | Unlimited |
| All runners | Yes | Yes | Yes | Yes |
| Session history | Yes | Yes | Yes | Yes |
| Offline alerts | Yes | Yes | Yes | Yes |
| Team management | No | No | No | Yes |
| Independent project switching per member | No | No | No | Yes |
| Session awareness notifications | No | No | No | Yes |
...
<AccordionGroup>
  ...
  <Accordion title="Do you offer refunds?">
    If you have an issue with billing, contact support via the bot (`/support`) or email. Refunds are handled case by case.
  </Accordion>

  <Accordion title="I'm on the Solo plan but need more than 3 projects. What do I do?">

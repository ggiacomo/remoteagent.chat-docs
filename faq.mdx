...
<AccordionGroup>
  ...
  <Accordion title="Can multiple Telegram users control the same agent?">
    Only on the **Team plan**, which allows up to 5 Telegram users. Each team member is added by the account owner from the dashboard. All team members have equal access to all agents and session history.

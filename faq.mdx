...
<AccordionGroup>
  ...
  <Accordion title="Can I use multiple projects?">
    ...
    When multiple agents are online, the bot asks which project to target when you send a command. You can also send `/projects` to see the list and tap to switch.
  </Accordion>

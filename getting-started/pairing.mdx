...
```json
{
  ...
  "runner": "claude-sdk",
  "redisUrl": "rediss://...",
  "apiBaseUrl": "https://remoteagent.chat"
}
```
...
<Note>
  Neither file is ever read by the RemoteAgent servers. The `agentToken` is a
  JWT used only to authenticate the Redis relay channel — it does not grant

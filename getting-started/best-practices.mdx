...
description: "Recommendations for a stable, reliable RemoteAgent setup — from server environment to process management."
---
...
RemoteAgent doesn't store your AI credentials — the runner must be authenticated on the machine.
